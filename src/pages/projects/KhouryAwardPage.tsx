...
const KhouryAwardPage: React.FC = () => {
    return (
        <Box minH="100vh" bg="brand.background">
            {/* Header */}
            <Box bg="linear-gradient(135deg, #FFD700 0%, #FFA500 100%)" py={20}>
                <Container maxW="1200px">
                    ...
                    <VStack align="start" spacing={4}>
                        ...
                        <HStack spacing={3} flexWrap="wrap">
                            <Tag bg="whiteAlpha.200" color="white" size="lg">Teaching Excellence</Tag>
                            <Tag bg="whiteAlpha.200" color="white" size="lg">Leadership</Tag>
                            <Tag bg="whiteAlpha.200" color="white" size="lg">Innovation</Tag>
                        </HStack>
                    </VStack>
                </Container>
            </Box>
